...
DEST_FILENAME=data-tf-2d-distorted-10
SRC_FILENAME=data-sorted-5
mkdir -p $DATA_PATH/$DEST_FILENAME
python3 build_image_data_2d.py --train_directory=$DATA_PATH/$SRC_FILENAME/train --output_directory=$DATA_PATH/$DEST_FILENAME  \
