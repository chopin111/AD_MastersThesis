# based on build_image_data.py
# https://raw.githubusercontent.com/tensorflow/models/master/inception/inception/data/build_image_data.py
...
contains the following fields:
  ...
  image/height: integer, image height in voxels
  image/width: integer, image width in voxels
  image/depth: integer, image depth in voxels
...
def _convert_to_example(filename, image_buffer, label, text, depth, height, width):
